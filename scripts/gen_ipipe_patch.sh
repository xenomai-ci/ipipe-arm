...
BEGIN {
    ...
    driver_arch["clocksource/bcm2835_timer.c"]="arm"
    driver_arch["clocksource/dw_apb_timer.c"]="arm"
    driver_arch["clocksource/dw_apb_timer_of.c"]="arm"
    ...
    driver_arch["gpio/gpio-pl061.c"]="arm"
    ...
    driver_arch["irqchip/irq-imx-gpcv2.c"]="arm"
    ...
    driver_arch["pinctrl/sunxi/pinctrl-sunxi.c"]="arm"
    driver_arch["pinctrl/sunxi/pinctrl-sunxi.h"]="arm"
    driver_arch["pinctrl/qcom/pinctrl-msm.c"]="arm"
    driver_arch["clocksource/arm_arch_timer.c"]="arm"
    driver_arch["clocksource/timer-sp804.c"]="arm"
    driver_arch["tty/serial/amba-pl011.c"]="arm"
    driver_arch["pci/host/pcie-altera.c"]="arm"
}
